...
class DefaultGroupStateInTransformer implements ErrorCodeTransformers.GroupStateIn {
     ...
     */
    @Override
    public Optional<LocationGroupState> available(@NotBlank String errorCode) {
        ...
        return Optional.of(errorCode.charAt(ErrorCodeVO.STATE_IN_POSITION) == 48 ? LocationGroupState.AVAILABLE : LocationGroupState.NOT_AVAILABLE);
    }
}
